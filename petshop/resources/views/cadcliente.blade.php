...
<html lang="en">
  ...
  <form>
      ...
      <legend class="tamanho" > Informações Pessoais Do Pet</legend>
       ...
       <div class="col-md-6 ">
         <input type="text" class="redondo form-control" placeholder="Nome do Pet" id="nomepet" />
       </div>
       <div class="form-group col-md-6">
       ...
       <div class="col-md-12">
          <input type="text" class="redondo form-control" placeholder="Observações Importante sobre o animal" id="obspet" />
        </div>
       <br><br><br>
